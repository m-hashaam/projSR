...
<title>Sweet Referrals -- Contact Us</title>
...
$footer.="<!-- Place this tag where you want the Live Helper Form module to render. -->
...
(function() {
var po = document.createElement('script'); po.type = 'text/javascript'; po.async = true;
po.src = '//portal.sweetreferrals.com/livechat/lhc_web/index.php/form/embed/2';
var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
})();
</script>";
