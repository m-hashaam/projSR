...
var Layout = function () {
		...
		$(".page-header .menu-toggler").on("click", function(event) {
			if (Metronic.getViewPort().width < 992) {
				...
				if (menu.hasClass("page-header-menu-opened")) {
					...
					$('.page-header .page-header-top .top-menu').prepend($('.page-header .menu-toggler'));
				}
	...
	var handleMainMenuOnResize = function() {
		// handle hover dropdown menu for desktop devices only
		if (Metronic.getViewPort().width >= 992) {
			$('.hor-menu [data-hover="classic-menu-dropdown"]').not('.hover-initialized').each(function() {
				$(this).dropdownHover();
				$(this).addClass('hover-initialized');
			});
			...
			$('.hor-menu [data-hover="classic-menu-dropdown"].hover-initialized').each(function() {
				$(this).unbind('hover');
