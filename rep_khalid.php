...
<script type="text/javascript" src="js/rep_khalid.js"></script>
...
SELECT HOUR(FROM_UNIXTIME(`k_time`)) AS ttime,`k_id` AS kid FROM `khalid`) t group by ttime";
                                                          $stmt =  $db->query($query);
                            ...
                            <h3 style="font-weight: bold; text-align: center;">Khalid Latif</h3>
                                            <table style=" width: 80% !important; margin-left: auto; margin-right: auto;" id="firstTable" class="table table-bordered table-hover table-condensed">
                                                ...
                                                $query = "SELECT `k_id`, `k_time`, `k_post`, `k_sentiment` FROM `khalid` WHERE 1";
                                                $stmt = $db->query($query);
                                                while($row = $stmt->fetch_assoc()){
                            ...
                            <h3 style="font-weight: bold; text-align: center;">Khalid Latif</h3>
                                            <table style=" width: 80% !important; margin-left: auto; margin-right: auto;" id="secondTable" class="table table-bordered table-hover table-condensed">
                                                ...
                                                <tr><td>Pakistan</td><td>Positive</td><td>Positive</td></tr>
                                                <tr><td>Government</td><td>Neutral</td><td>Neutral</td></tr>
                                                <tr><td>Education</td><td>Positive</td><td>Positive</td></tr>
                                                <tr><td>Data</td><td>Positive</td><td>Neutral</td></tr>
                                                <tr><td>University</td><td>Positive</td><td>Neutral</td></tr>
                                                <tr><td>Election</td><td>Negative</td><td>Neutral</td></tr>
                                                <tr><td>Technology</td><td>Positive</td><td>Neutral</td></tr>
                                                <tr><td>National</td><td>Positive</td><td>Positive</td></tr>
                                                <tr><td>Analysis</td><td>Positive</td><td>Neutral</td></tr>
                                                <tr><td>Media</td><td>Negative</td><td>Negative</td></tr>
                                               </tbody></table>
                                ...
                                <div>
                                      ...
                                      <script>
                                            ...
                                            function drawChart3() {
                                              ...
                                              data.addRows([ ';
                                                          $query = "SELECT MONTH(FROM_UNIXTIME(`kw_time`)) AS mm,YEAR(FROM_UNIXTIME(`kw_time`)) AS yy, COUNT(`kw_word`) AS cc, `kw_type`, `kw_pos`, `kw_polarity` FROM `khalid_words` WHERE  `kw_pos` = 'adj' group by yy,mm";
                                                          $stmt =  $db->query($query);
                                                          while($row = $stmt->fetch_assoc()){
                                                            $yy = $row['yy'];
                                                            $mm = $row['mm'];
