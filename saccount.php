...
if(!(isset($_SESSION['sub_idSR']))){
	$server = $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'];
	$server = substr($server,0,strrpos($server,"/"));
	header('Location: http://'.$server.'/account.php');
}
...
<script type="text/javascript" src="js/saccount.js"></script>
            ...
            <form role="form" action="changeaccount.php" id="form_sample_2" novalidate="novalidate">
                ...
                <div class="form-group field-div has-success">
                    ...
                    <div class="input-icon right">
                        ...
                        <input type="text" placeholder="michael@swaggable.com" class="form-control" value="'.$email.'" name="email" id="email" aria-required="true" aria-describedby="email-error">
                    </div>
                </div>
            </form>
            <div class="row">
