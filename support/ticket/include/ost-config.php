...
define('SECRET_SALT','XPbeCifi80bO6_EPQFhRhXWpoXJgKnt6');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','ali.haider@sweetreferrals.com');
...
define('DBNAME','sweetref_portal');
define('DBUSER','sweetref_portal');
define('DBPASS','Popo1122!!@@');

# Table prefix
define('TABLE_PREFIX','ticketing_');
